...
return {
  apply(ctx) {
    ...
    ctx.effect(() => styles.insert(
      ...
      '@keyframes dsh-tablist-collapse{0%{opacity:1;top:var(--dsh-tablist-top,158px);right:12px;left:auto;width:216px;align-items:stretch;gap:4px;padding-left:4px;transform:none;animation-timing-function:var(--ds-ease-in-out,cubic-bezier(0.4,0,0.2,1))}49.99%{opacity:0;top:var(--dsh-tablist-top,158px);right:12px;left:auto;width:216px;align-items:stretch;gap:4px;padding-left:4px;transform:none}50%{opacity:0;top:66px;right:0;left:auto;width:56px;align-items:center;gap:12px;padding-left:0;transform:translateX(-49px);animation-timing-function:var(--ds-ease-in-out,cubic-bezier(0.4,0,0.2,1))}100%{opacity:1;top:66px;right:0;left:auto;width:56px;align-items:center;gap:12px;padding-left:0;transform:none}}' +
      ...
      "[data-phase]:has([data-sidebar='on']) [data-slot='conversation.session.header'] header > div:first-child{width:220px;min-width:220px;min-height:0;flex-direction:column;align-items:stretch;gap:8px}" +
      ...
      "[data-phase]:has([data-sidebar='on']) [data-slot='conversation.session.header'] header > div:first-child > div:last-child{position:relative;display:flex;flex-direction:row;align-items:center;gap:10px;margin-left:0;padding-top:4px;max-width:100%;min-width:0}" +
      ...
      "[data-phase]:has([data-sidebar='on']) [role='tablist']{--dsh-tablist-top:158px;position:absolute;top:var(--dsh-tablist-top,158px);right:12px;left:auto;width:216px;display:flex;flex-direction:column;align-items:stretch;gap:4px;padding-left:4px;animation:dsh-tablist-expand 200ms both}" +
      "[data-phase]:has([data-sidebar='on']):has([data-dev='on']) [role='tablist']{--dsh-tablist-top:218px}" +
